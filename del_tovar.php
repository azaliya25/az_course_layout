...
if (isset($_GET['id']) && isset($_GET['action'])) {
    ...
    if ($action == 'delete') {
        $delete_sql = "DELETE FROM tovar WHERE id='$get_id'";
...
<body>
    ...
    <div class="del container">
        ...
        <div class="action_del">
            ...
            if (isset($_GET['id'])) {
                $get_id = $_GET['id'];
                echo '<a href="tovar.php?id=' . $get_id . '&action=cancel" class="del_a_cancel">отменить</a>';
                echo '<p>/</p>';
                echo '<a href="del_tovar.php?id=' . $get_id . '&action=delete" class="del_a_delete">удалить</a>';
            } else {
